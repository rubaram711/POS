...
class ReusableItemRowInTransferDetails extends StatefulWidget {
  const ReusableItemRowInTransferDetails({super.key, required this.transferredItemInfo, required this.index});
        ...
        child: Form(
          ...
          child: Row(
            ...
            children: [
              ...
              ReusableShowInfoCard(text: widget.transferredItemInfo['mainDescription']??'', width: MediaQuery.of(context).size.width * 0.2),
              ...
              ReusableShowInfoCard(text: '${widget.transferredItemInfo['receivedQty']??''}', width: MediaQuery.of(context).size.width * 0.1),
              ReusableShowInfoCard(text: '${widget.transferredItemInfo['transferredQtyPackageName']??''}', width: MediaQuery.of(context).size.width * 0.05),
              ReusableShowInfoCard(text: '${widget.transferredItemInfo['qtyDifference']??''}', width: MediaQuery.of(context).size.width * 0.1),
              ReusableShowInfoCard(text: '${widget.transferredItemInfo['transferredQtyPackageName']??''}', width: MediaQuery.of(context).size.width * 0.05),
              ReusableShowInfoCard(text: widget.transferredItemInfo['note']??'', width: MediaQuery.of(context).size.width * 0.1),
            ],
          ),
        ),
      );
