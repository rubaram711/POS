          ...
          return pw.Center(
            ...
            children: [
              ...
              clientController.selectedCustomerIdWithOk != '-1'
                ...
                clientController.selectedCustomerObject['country'] !=
                    ...
                    clientController
                              ...
                              : pw.SizedBox(),
                      pw.SizedBox(height: 5),
                clientController.selectedCustomerObject['phoneNumber']??clientController.selectedCustomerObject['phone_number'] !=
                              null
                          ? pw.Text(
                ...
                clientController.selectedCustomerObject['taxId'] !=
                                  null ||
                              '${clientController.selectedCustomerObject['taxId']}' ==
                                  '0' || clientController.selectedCustomerObject['tax_id'] !=
                                  null ||
              ...
              pw.Row(mainAxisAlignment: pw.MainAxisAlignment.start, children: [
                pw.Text('${'served_by'.tr} ${homeController.useName}',
                    style: pw.TextStyle(fontSize: fontSize)),
              ]),
              pw.SizedBox(height: 5),
              pw.Row(
              ...
              pw.SizedBox(height: 10),
               productController.totalDiscount!=0? pw.Container(
                margin: const pw.EdgeInsets.symmetric(horizontal: 3),
                child: pw.Table(
                  border: pw.TableBorder.all(color: PdfColors.white),
                  children:[
                    pw.TableRow(
                      children: [
                        ...
                        pw.Container(
                          width: 90, // Set specific width for the price cell
                          child: pw.Text(
                              numberWithComma(productController.totalDiscount
                                  .toString()),
                              style: pw.TextStyle(
                                fontSize: fontSize,
                              )),
